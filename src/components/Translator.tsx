...
//   useEffect(() => {
//     const voices = window.speechSynthesis.getVoices();
//     setVoices(voices.length > 0 ? voices : []);
...
//   function speak(text: string) {
//     const utterance = new SpeechSynthesisUtterance(text);
//     const activeVoice = voices.find(voice => voice.lang === language);
//     if (activeVoice) {
//       utterance.voice = activeVoice;
//     }
//     window.speechSynthesis.speak(utterance);
...
//     .map(lang => ({
//       lang,
//       label: languageCodes[lang.split('-')[0]] || lang,
//       dialect: countryCodes[lang.split('-')[1]],
//     }))
//     .sort((a, b) => a.label.localeCompare(b.label));

//   return (
//     <div className="mt-12 px-4">
//       <div className="max-w-lg rounded-xl overflow-hidden mx-auto bg-zinc-200 p-4">
//         <div className="bg-blue-200 rounded-lg p-2 border-2 border-blue-300">
//           <ul className="font-mono font-bold text-blue-900 uppercase px-4 py-2 border border-blue-800 rounded">
//             <li>Translation Mode: {languageCodes[language.split('-')[0]]}</li>
